...
public class LootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addVerticalSlabDrops(NemosVerticalBlocks.PALE_OAK_VERTICAL_SLAB.get());
        ...
        addVerticalSlabDrops(NemosVerticalBlocks.MOSSY_PALE_OAK_VERTICAL_SLAB.get());
        ...
        addVerticalSlabDrops(NemosVerticalBlocks.PALE_MOSSY_PALE_OAK_VERTICAL_SLAB.get());
        ...
        addVerticalSlabDrops(NemosVerticalBlocks.CRIMSON_MOSSY_PALE_OAK_VERTICAL_SLAB.get());
        ...
        addVerticalSlabDrops(NemosVerticalBlocks.WARPED_MOSSY_PALE_OAK_VERTICAL_SLAB.get());
